...
<body>
<h2>Gigya OIDC Demo OP Consent Page</h2>
...
$(document).ready(function () {
    ...
    $("#b_js_sigBtn").click(function(){
        var b_js_newUrl="OIDCProxyPage.php?mode=afterConsent&consent=" + b_js_consentOBJString + "&sig=" + consentObj2Sig + "&userKey=" + userKi;
